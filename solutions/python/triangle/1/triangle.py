def equilateral(sides):
    return is_valid_triangle(sides) and sides[0]==sides[1] and sides[1]==sides[2]
...
def is_valid_triangle(sides):
    return sides[0]>0 and sides[0]+sides[1]>=sides[2] and sides[1]+sides[2]>=sides[0] and sides[0] + sides[2]>=sides[1]